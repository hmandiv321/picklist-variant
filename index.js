...
// initial load
  ...
  const editEdi = { documentTypeKey: 1, statusKey: 0 };
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  edis = [
    ...edis,
    ...getAvailableDocumentTypes().filter((doc)=> doc.documentTypeKey === replaceEdi.documentTypeKey).map((doc)=> ({...doc, statusKey:addEdi.statusKey}))
  ];
